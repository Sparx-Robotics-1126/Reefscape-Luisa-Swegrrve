...
public class SparkMaxEncoderSwerve extends SwerveAbsoluteEncoder {
   ...
   * com.revrobotics.spark.SparkMax} motor.
   *
  ...
  public void setConversionFactor(double conversionFactor) {
    ...
    // Some of the frames can probably be adjusted to decrease CAN utilization, with 65535 being the
    // max.
    // From testing, 20ms on frame 5 sometimes returns the same value while constantly powering the
    // azimuth but 8ms may be overkill,
