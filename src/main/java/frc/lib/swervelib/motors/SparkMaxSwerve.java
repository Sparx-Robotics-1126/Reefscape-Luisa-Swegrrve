...
public class SparkMaxSwerve extends SwerveMotor {
  ...
  public void configureIntegratedEncoder(double positionConversionFactor) {
    ...
    // Notability this changes the returned velocity and the velocity used for the onboard velocity
    // PID loop (TODO: triple check the PID portion of this statement)
    ...
    cfg.encoder.quadratureMeasurementPeriod(32).quadratureAverageDepth(8);
