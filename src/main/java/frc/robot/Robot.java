...
public class Robot extends TimedRobot {
    ...
    private TeamLights lights = new TeamLights(RobotContainer.ledSubsystem);
    private RainbowCommand rainbow = new RainbowCommand(RobotContainer.ledSubsystem);
    ...
    public void robotInit() {
        ...
        // should this be resetPose(...)?
        RobotContainer.m_swerve.tareRotation();
