...
public class AlgaeAcquisition extends SubsystemBase {
    ...
    ElevatorFeedforward m_feedforward = new ElevatorFeedforward(kRotationkS, kRotationkG, kRotationkV, kRotationkA);
    ...
    private void configurePID() {
        rotationConfig.closedLoop.p(.2).i(0).d(0).feedbackSensor(FeedbackSensor.kPrimaryEncoder);
    }
    ...
    private void configureSparkMaxes() {
        algaeWheels.configure(
            wheelConfig,
            SparkBase.ResetMode.kNoResetSafeParameters,
            SparkBase.PersistMode.kNoPersistParameters
        );
        algaeRotation.configure(
            rotationConfig,
            SparkBase.ResetMode.kNoResetSafeParameters,
            SparkBase.PersistMode.kNoPersistParameters
        );
