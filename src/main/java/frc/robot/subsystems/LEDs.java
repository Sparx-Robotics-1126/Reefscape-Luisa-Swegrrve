...
public class LEDs extends SubsystemBase {
    ...
    public void setGradient(Color8Bit startColor, Color8Bit endColor) {
        for (int i = 0; i < ledBuffer.getLength(); i++) {
            ...
            int green = (int) (startColor.green +
                ((endColor.green - startColor.green) * i) / (double) ledBuffer.getLength());
            int blue = (int) (startColor.blue +
                ((endColor.blue - startColor.blue) * i) / (double) ledBuffer.getLength());
