...
public class AutoFactory {
    ...
    static record AllianceContext(boolean useAllianceFlipping, Supplier<Optional<Alliance>> allianceGetter) {
    ...
    public <ST extends TrajectorySample<ST>> AutoFactory(
        ...
        this(poseSupplier, resetOdometry, controller, useAllianceFlipping, driveSubsystem, (sample, isStart) -> {});
    }
