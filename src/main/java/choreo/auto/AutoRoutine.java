...
public class AutoRoutine {
    ...
    private final Trigger isActiveTrigger = new Trigger(loop, () -> isActive && DriverStation.isEnabled());
    ...
    /**
     * Returns the name of the auto routine.
     * @return The name of the auto routine this loop is associated with.
     */
